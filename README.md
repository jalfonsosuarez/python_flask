...
## End-points de prueba:
    ...
    GET localhost:5010/lista 
        -> muestra una lista de frutas.
    GET localhost:5010/numeros 
        -> muestra una lista de números indicando cuales son pares y cuales impares.
    GET localhost:5010/web 
        -> Prueba del servidor.
    GET localhost:5010/web/usuario/<nombre>/<apellido>     
        -> Muestra 'Hola <nombre> <apellido>'.
    GET localhost:5010/web/edad/<edad>     
        -> Muestra 'Tienes <edad> años'.
    GET localhost:5010/web/contacto 
        -> Muestra un formulario de datos de contacto.
    POST localhost:5010/web/contacto (Se ejecuta al enviar el formulario) 
        -> Muestra 'Mensaje enviado'.
    GET localhost:5010/web/sumar 
        -> Muestra un formulario que pide dos números.
    POST localhost:5010/web/sumar (Se ejecuta al enviar el formulario) 
